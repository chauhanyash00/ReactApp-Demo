...
export default function TextForm(props) {
  ...
  return (  
        ...
        <div class="container my-5">    
            <h1>{props.title}</h1>
            <textarea class={`form-control bg-${props.mode === 'light' ? 'light' : 'dark'} text-${props.mode === 'light' ? 'dark' : 'light'}`} id="exampleFormControlTextarea1" rows="9" value={text} onChange={changeOnText}></textarea>
